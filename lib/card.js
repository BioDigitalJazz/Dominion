...
function AdventurerCard() {
  ActionCard.call(this, 7, 'Adventurer', 6, '/images/cards/adventurer.jpg');
  this.types.action = true;
...
function BureaucratCard() {
  ActionCard.call(this, 8, 'Bureaucrat', 4, '/images/cards/bureaucrat.jpg');
  this.types.action = true;
...
function CellarCard() {
  ActionCard.call(this, 9, 'Cellar', 2, '/images/cards/cellar.jpg');
  this.types.action = true;
...
function ChancellorCard() {
  ActionCard.call(this, 10, 'Chancellor', 3, '/images/cards/chancellor.jpg');
  this.types.action = true;
...
function ChapelCard() {
  ActionCard.call(this, 11, 'Chapel', 2, '/images/cards/chapel.jpg');
  this.types.action = true;
...
function CouncilRoomCard() {
  ActionCard.call(this, 12, 'CouncilRoom', 5, '/images/cards/councilroom.jpg');
  this.types.action = true;
...
function FeastCard() {
  ActionCard.call(this, 13, 'Feast', 4, '/images/cards/feast.jpg');
  this.types.action = true;
